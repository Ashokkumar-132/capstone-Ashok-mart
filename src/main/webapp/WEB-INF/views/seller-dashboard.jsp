...
<main class="seller-layout">
    ...
    <section class="seller-stat-grid" aria-label="Product summary"><article class="seller-stat"><span>Total products</span><strong>${productCount}</strong></article><article class="seller-stat"><span>Active products</span><strong>${activeProductCount}</strong></article><article class="seller-stat"><span>Out of stock</span><strong>${outOfStockCount}</strong></article></section>
